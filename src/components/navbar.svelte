...
<nav
	...
	class={`bg-background/95 dark:bg-background-dark/95 supports-[backdrop-filter]:bg-background/60
     dark:supports-[backdrop-filter]:bg-background-dark/60 dark:border-border-dark border-border fixed top-0 z-50 w-full border-b px-4 backdrop-blur flex justify-center
      md:justify-center md:px-6 ${fontClass()}`}
>
	<div class="w-full max-w-7xl">
		...
		{#if menuOpen}
			<div class="md:hidden" in:slide={{ axis: 'y' }} out:slide={{ axis: 'y' }}>
				...
				<div
					class="border-border dark:border-border-dark mb-4 flex w-full flex-row items-center justify-center gap-2 rounded-full border px-4 py-2 text-black dark:text-white"
				>
					<svg
						xmlns="http://www.w3.org/2000/svg"
						fill="none"
		...
		{/if}
		{#if searchOpen}
			<div class="hidden md:block" in:slide={{ axis: 'y' }} out:slide={{ axis: 'y' }}>
				<div class="flex w-full items-center justify-center pt-2 pb-4">
					<div
						class="border-border dark:border-border-dark flex w-full max-w-7xl flex-row items-center justify-center gap-2 rounded-full border px-4 py-2 text-black dark:text-white"
					>
						<svg
							xmlns="http://www.w3.org/2000/svg"
							fill="none"
